    ...
    <div class="col-12 p-0">
        <div id="myCarouselExampleIndicators" class="carousel slide " data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active  col-lg-8 offset-lg-2 animation-duration2 fadeInUp">
                    @php
                    $counter++;
                    @endphp
                    <div class="row">
                        <div class="col-12 about-first-slide  text-justify">
                            <h1 class="montserrat-bold text-center">About BITE of art</h1>

                            <p class="montserrat-regular mt-5">The <b>BITE of Art </b> initiative represents a joint vision
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a target="_blank" href="https://ec.europa.eu/programmes/creative-europe/node_en">
                                ...
                                data-hover  = "{{ asset('images/about/partners/creative_europe.png') }}"
                                alt="slide 2">
                            </a>
                        ...
                        <div class="col-4">
                            <a target="_blank" href="http://bum.org.rs/">
                                <img class="img-fluid  d-block gallery-img about-bum"
                                    ...
                                    data-hover  = "{{ asset('images/about/partners/BUM.png') }}"
                                    alt="slide 2">
                            </a>
                        ...
                        <div class="col-4">
                            ...
                            <a target="_blank" href="https://www.mladizmaji.si/en/">
                                <img class="img-fluid  d-block gallery-img about-zmaji"
                                    ...
                                    data-hover  = "{{ asset('images/about/partners/mladi_zmaji.png') }}"
                                    alt="slide 2">
                            </a>
                        ...
                        <div class="col-4 ">
                            <a target="_blank" href="http://www.backslash.es/">
                                <img class="img-fluid  d-block gallery-img about-blackslash"
                                    ...
                                    data-hover  = "{{ asset('images/about/partners/Backslash.png') }}"
                                    alt="slide 2">
                            </a>
                        </div>
                        <div class="col-4"></div>
                        <div class="col-4">
                            <a target="_blank" href="http://communications.rs/">
                                <img class="img-fluid  d-block gallery-img about-colormedia"
                                    ...
                                    data-hover  = "{{ asset('images/about/partners/color_media.png') }}"
                                    alt="slide 2">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-4 ">
                            <a target="_blank" href="http://connect-international.org/en/">
                                <img class="img-fluid  d-block gallery-img about-connect"
                                    ...
                                    data-hover  = "{{ asset('images/about/partners/Connect_logo.png') }}"
                                    alt="slide 2">
                            </a>
