    ...
    <tbody>
      ...
      <tr>
        ...
        {{-- <td>
                        ...
                        <img src = "{{asset('images/galleries/'.$event->event_img_1) }}" class="img-fluid"> <p>
          {{ $event->event_img_1_desc }}</p>
        <img src="{{ $event->event_img_2 }}" class="img-fluid">
        <p>{{ $event->event_img_2_desc }}</p>
        <img src="{{ $event->event_img_3 }}" class="img-fluid">
        <p>{{ $event->event_img_3_desc }}</p>
        </td> --}}

        <td><a href="{{ $event->event_media }}">{{ substr($event->event_media, 0, 45) }}</a> <br />
          {{ $event->event_media_des }}</td>
        ...
        <td>
          ...
          <a class="text-primary all-event-data" href= " {{ route('moderator.event.artist.update',['id'=>$event->id, 'language'=>app()->getLocale() ]) }}">
